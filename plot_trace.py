...
for n in range(start,stop+step,step):
    ...
    workx2d = np.loadtxt('./txt/work_x_'+str(n).zfill(4)+'sdf.txt')
    worky2d = np.loadtxt('./txt/work_y_'+str(n).zfill(4)+'sdf.txt')

    
    plt.subplot()
    plt.scatter(work_x, work_y, c=color_index, s=3, cmap='gnuplot2', edgecolors='None')
 ...
 #   plt.legend(loc='upper right')
    ...
    fig.savefig('./part_fig/theta'+str(n).zfill(4)+'.png',format='png',dpi=80)
    plt.close("all")
