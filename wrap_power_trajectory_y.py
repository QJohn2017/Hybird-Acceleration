...
plt.xticks([],fontsize=20); plt.yticks([-1,0,1],fontsize=20);
...
ax.fill_between(xx[index,:],y1,y2, where=y1<=y2, facecolor='red',alpha=0.3,interpolate=True)
plt.scatter(xx[index,:], y1, c=gg[index,:], norm=norm_y, s=6, cmap='winter', edgecolors='None')
plt.xticks([],fontsize=20); plt.yticks([-1,0,1,2],fontsize=20);
...
fig.savefig('./figure_wrap_up/'+'trajectory_power_y.png',format='png',dpi=160)
plt.close("all")
