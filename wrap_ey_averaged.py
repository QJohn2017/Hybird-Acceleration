...
##end for norm colorbar####
    ...
    ax.text(21.5,6.6,'$\overline{E_y}$ [m$_e$c$\omega_0$/e]',fontdict=font)      
    ...
    ax.text(7.5,6.6,'t = 116.67 fs',fontdict=font)
    ax.set_xlim(0,40)
    ax.set_ylim(-8.5,8.5)
    ...
    ax.text(21.5,6.6,'$\overline{B_z}$ [m$_e\omega_0$/e]',fontdict=font) 
    cbar.ax.set_xticklabels(cbar.ax.get_xticklabels(),fontsize=15)
    #plt.xlabel(r'X [$\lambda_0$]',fontdict=font)
    ax.set_ylabel('Y [$\lambda_0$]',fontdict=font)
    ax.tick_params(axis='y',labelsize=20)
    ax.tick_params(axis='x',labelsize=0)
    ax.yaxis.set_ticks(ticks=[-8.0,-4.0,0,4.0,8.0])
    ax.text(6,6.6,'t = 116.67 fs',fontdict=font)
    ax.set_xlim(0,40)
    ax.set_ylim(-8.5,8.5)
   ...
   # cbar.set_label('-$\overline{E_y}$+c$\overline{B_z}$ [m$_e$c$\omega_0$/e]',fontdict=font)   
    ax.text(18.5,6.6,'-$\overline{E_y}$+c$\overline{B_z}$ [m$_e$c$\omega_0$/e]',fontdict=font)   
    cbar.ax.set_xticklabels(cbar.ax.get_xticklabels(),fontsize=15)
    #### manifesting colorbar, changing label and axis properties ####
    ax.set_ylabel('Y [$\lambda_0$]',fontdict=font)
...
#    ax.set_ylabel('Y [$\lambda_0$]',fontdict=font)
    ...
    fig.savefig('./figure_wrap_up/Ey_Bz_averaged.png',format='png',dpi=160)
    #plt.close("all")
